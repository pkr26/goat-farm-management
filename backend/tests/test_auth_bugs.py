...
async def test_register_oversized_name_returns_500(client: httpx.AsyncClient) -> None:
...
# FIXED — regression test
async def test_create_farm_oversized_location_returns_500(client: httpx.AsyncClient) -> None:
...
# FIXED — regression test
async def test_create_farm_whitespace_only_name_accepted(client: httpx.AsyncClient) -> None:
...
# FIXED — regression test
async def test_farm_header_within_range_but_beyond_int32_returns_500(
...
# FIXED — regression test
async def test_login_with_non_argon2_stored_hash_returns_500(client: httpx.AsyncClient) -> None:
...
# FIXED — regression test
async def test_login_with_bcrypt_stored_hash_returns_500(client: httpx.AsyncClient) -> None:
